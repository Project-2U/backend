...
class Query(ProfileQuery, UserQuery, OrderQuery, NotificationQuery, OrderProductQuery,ProductQuery):
    pass
    
class Mutation(ProfileMutation, UserMutation, OrderMutation, ProductMutation, OrderProductMutation, NotificationMutation):
    pass
